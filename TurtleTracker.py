...
#
# Created by: Hannah Palmer-Dwore (jpfay@duke.edu)
# Created on: Oct 2016
...
obsDateTime = lineData[2]           # Observation date and time (combined); grabbed as one
obsDate = obsDateTime.split()[0]    # Observation date - first item in obsDateTime list object; 0 - 1st thing
obsTime = obsDateTime.split()[1]    # Observation time - second item in obsDateTime list object; 1 - 2nd thing
